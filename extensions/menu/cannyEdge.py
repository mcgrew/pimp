...
from extensions.lib.core import spatial, stringCopy
...
def execute( width, height, data ):
    ...
    edge1 = spatial( width, height, stringCopy(data), FILTER1 )[2]
    edge2 = spatial( width, height, stringCopy(data), FILTER2 )[2]
    edge3 = spatial( width, height, stringCopy(data), FILTER3 )[2]
    edge4 = spatial( width, height, stringCopy(data), FILTER4 )[2]
