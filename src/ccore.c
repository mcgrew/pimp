...
const static char string_copy__doc__[] =
"Makes a real copy of a string. This can only be accomplished through tricks "
    "in pure python.\n"
"\n"
":Parameters:\n"
"    indata : string\n"
...
"\n"
":rtype: string\n"
":returns: A real copy of the string so the original data cannot be changed by "
    "C extensions.\n";

PyObject *string_copy(PyObject *pself, PyObject *pArgs)
{
    char *data, *outData;
    Py_ssize_t dataLen;
    ...
    if(!(outData = malloc(dataLen)))
    {
         PyErr_SetString(PyExc_MemoryError,
                 "Memory could not be allocated to copy the string");
         return NULL;
    }
...
//doc string
const static char swap_channels__doc__[] =
"Swaps one channel with another in an image. The channels are:\n"
"0 - Red\n"
"1 - Green\n"
"2 - Blue\n"
"3 - Alpha (if present)\n"
...
PyObject *swap_channels(PyObject *pself, PyObject *pArgs)
{
    ...
    if((channel1 < 0) || (channel2 < 0))
    {
         PyErr_SetString(PyExc_IndexError,
                 "Negative values for channel number are not valid");
         return NULL;
    }
    ...
    if((channel1 > channels) || (channel2 > channels))
    {
         PyErr_Format(PyExc_IndexError,
                 "This channel contains only %d channels", channels);
         return NULL;
    }
...
// doc string
const static char table__doc__[] =
"Replaces the data in an image based on a substitution table. The table should "
"contain 256 values, each containing the value to be substituted. It is "
"treated as a lookup table; a value of 205 will be replaced with whatever is "
"at index 205 in the table, and so forth.\n"
"\n"
":Parameters:\n"
"    width : int\n"
"        The width of the image in pixels\n"
...
":returns: A tuple (width, height, data). Width and height are in pixels, "
    "data is a string containing the binary data.\n";
...
PyObject *table(PyObject *pself, PyObject *pArgs)
{
    ...
    if (!PyArg_ParseTuple(pArgs, "iiy#("
            ...
            &sub_table[ 0], &sub_table[ 1], &sub_table[ 2], &sub_table[ 3],
            &sub_table[ 4], &sub_table[ 5], &sub_table[ 6], &sub_table[ 7],
            &sub_table[ 8], &sub_table[ 9], &sub_table[10], &sub_table[11],
            &sub_table[12], &sub_table[13], &sub_table[14], &sub_table[15],
            &sub_table[16], &sub_table[17], &sub_table[18], &sub_table[19],
            &sub_table[20], &sub_table[21], &sub_table[22], &sub_table[23],
            &sub_table[24], &sub_table[25], &sub_table[26], &sub_table[27],
            &sub_table[28], &sub_table[29], &sub_table[30], &sub_table[31],
            &sub_table[32], &sub_table[33], &sub_table[34], &sub_table[35],
            &sub_table[36], &sub_table[37], &sub_table[38], &sub_table[39],
            &sub_table[40], &sub_table[41], &sub_table[42], &sub_table[43],
            &sub_table[44], &sub_table[45], &sub_table[46], &sub_table[47],
            &sub_table[48], &sub_table[49], &sub_table[50], &sub_table[51],
            &sub_table[52], &sub_table[53], &sub_table[54], &sub_table[55],
            &sub_table[56], &sub_table[57], &sub_table[58], &sub_table[59],
            &sub_table[60], &sub_table[61], &sub_table[62], &sub_table[63],
            &sub_table[64], &sub_table[65], &sub_table[66], &sub_table[67],
            &sub_table[68], &sub_table[69], &sub_table[70], &sub_table[71],
            &sub_table[72], &sub_table[73], &sub_table[74], &sub_table[75],
            &sub_table[76], &sub_table[77], &sub_table[78], &sub_table[79],
            &sub_table[80], &sub_table[81], &sub_table[82], &sub_table[83],
            &sub_table[84], &sub_table[85], &sub_table[86], &sub_table[87],
            &sub_table[88], &sub_table[89], &sub_table[90], &sub_table[91],
            &sub_table[92], &sub_table[93], &sub_table[94], &sub_table[95],
            &sub_table[96], &sub_table[97], &sub_table[98], &sub_table[99],
            &sub_table[100], &sub_table[101], &sub_table[102], &sub_table[103],
            &sub_table[104], &sub_table[105], &sub_table[106], &sub_table[107],
            &sub_table[108], &sub_table[109], &sub_table[110], &sub_table[111],
            &sub_table[112], &sub_table[113], &sub_table[114], &sub_table[115],
            &sub_table[116], &sub_table[117], &sub_table[118], &sub_table[119],
            &sub_table[120], &sub_table[121], &sub_table[122], &sub_table[123],
            &sub_table[124], &sub_table[125], &sub_table[126], &sub_table[127],
            &sub_table[128], &sub_table[129], &sub_table[130], &sub_table[131],
            &sub_table[132], &sub_table[133], &sub_table[134], &sub_table[135],
            &sub_table[136], &sub_table[137], &sub_table[138], &sub_table[139],
            &sub_table[140], &sub_table[141], &sub_table[142], &sub_table[143],
            &sub_table[144], &sub_table[145], &sub_table[146], &sub_table[147],
            &sub_table[148], &sub_table[149], &sub_table[150], &sub_table[151],
            &sub_table[152], &sub_table[153], &sub_table[154], &sub_table[155],
            &sub_table[156], &sub_table[157], &sub_table[158], &sub_table[159],
            &sub_table[160], &sub_table[161], &sub_table[162], &sub_table[163],
            &sub_table[164], &sub_table[165], &sub_table[166], &sub_table[167],
            &sub_table[168], &sub_table[169], &sub_table[170], &sub_table[171],
            &sub_table[172], &sub_table[173], &sub_table[174], &sub_table[175],
            &sub_table[176], &sub_table[177], &sub_table[178], &sub_table[179],
            &sub_table[180], &sub_table[181], &sub_table[182], &sub_table[183],
            &sub_table[184], &sub_table[185], &sub_table[186], &sub_table[187],
            &sub_table[188], &sub_table[189], &sub_table[190], &sub_table[191],
            &sub_table[192], &sub_table[193], &sub_table[194], &sub_table[195],
            &sub_table[196], &sub_table[197], &sub_table[198], &sub_table[199],
            &sub_table[200], &sub_table[201], &sub_table[202], &sub_table[203],
            &sub_table[204], &sub_table[205], &sub_table[206], &sub_table[207],
            &sub_table[208], &sub_table[209], &sub_table[210], &sub_table[211],
            &sub_table[212], &sub_table[213], &sub_table[214], &sub_table[215],
            &sub_table[216], &sub_table[217], &sub_table[218], &sub_table[219],
            &sub_table[220], &sub_table[221], &sub_table[222], &sub_table[223],
            &sub_table[224], &sub_table[225], &sub_table[226], &sub_table[227],
            &sub_table[228], &sub_table[229], &sub_table[230], &sub_table[231],
            &sub_table[232], &sub_table[233], &sub_table[234], &sub_table[235],
            &sub_table[236], &sub_table[237], &sub_table[238], &sub_table[239],
            &sub_table[240], &sub_table[241], &sub_table[242], &sub_table[243],
            &sub_table[244], &sub_table[245], &sub_table[246], &sub_table[247],
            &sub_table[248], &sub_table[249], &sub_table[250], &sub_table[251],
            &sub_table[252], &sub_table[253], &sub_table[254], &sub_table[255]))
        return NULL;
    ...
    for (i=0; i < 256; i++)
    {
        if (sub_table[i] > 255)
        {
            PyErr_SetString(PyExc_ValueError, "Invalid value in substitution "
                    "table, must be in range(256)");
            return NULL;
        }
    }
 ...
 *
 * returntype: int
 * returns: The size of the resulting square filter on one side
...
int parseFilter(PyObject *PyFilter, int **CFilter)
{
   ...
   {
        (*CFilter)[position] =
            (int)PyLong_AS_LONG(PyTuple_GetItem(PyFilter, position));
   }

   return size;
}

const static char spatial__doc__[] =
...
"The filter will be truncated to the nearest square of an odd number if this "
    "is not the case.\n"
"\n"
":Parameters:\n"
"    width : int\n"
...
"    filterTotal : int\n"
"        The total weight of the filter the final result is to be divided by. "
        "This is optional and automatically determined if left out.\n"
"\n"
":rtype: tuple\n"
":returns: A tuple (width, height, data). Width and height are in pixels, "
...
PyObject *spatial(PyObject *pself, PyObject *pArgs)
{
    ...
    int filterTotal=0;  // total weight of the filter (the number to divide by)
    ...
    {
         PyErr_SetString(PyExc_MemoryError,
                 "Memory could not be allocated to create the new image");
         return NULL;
    }
    ...
    for (i= edgeSize * channels; i < (width - edgeSize)*channels; i+=channels)
    {
        for (j= edgeSize; j < height - edgeSize ; j++)
        {
            ...
            for (position = k; position < k + 3; position++)
            {
                ...
                {
                    tmp += data[position +
                        ((m / filterSize - edgeSize) * width * channels) +
                        ((m % filterSize - edgeSize) * channels)] * filter[m];
                }
...
const static char quick_scale__doc__[] =
...
PyObject *quick_scale(PyObject *pself, PyObject *pArgs)
{
    ...
    // grab each pixel from a relative position in the original image and place
    // it at (i, j) in the new image this will produce fairly good results 
    // when scaling down, less so when scaling up.
    for (i=0; i < newWidth; i++)
    {
        for (j=0; j < newHeight; j++)
        {
            newPosition = (i + j * newWidth) * channels;
            oldPosition = ((int)(i * xRatio) + (int)(j * yRatio) * width)
                * channels;
...
const static char to_rgb__doc__[] =
...
"\n"
":rtype: tuple\n"
":returns: a tuple containing a width, height, and data as a string in RGB "
    "format\n";

PyObject *to_rgb(PyObject *pself, PyObject *pArgs)
{
    ...
    {
         PyErr_Format(PyExc_ValueError, "Data contained an invalid number of "
                 "channels, 3-4 expected, %d recieved (width: %d, "
                 "height: %d, bytes: %d)", channels, width, height, dataLen);
         return NULL;
    }
    ...
    // Build a python tuple and return it.
    return Py_BuildValue("(iiy#)", width, height, newData,
            (width * height * 3));

}

const static char to_rgba__doc__[] =
...
PyObject *to_rgba(PyObject *pself, PyObject *pArgs)
{
       unsigned int width, height, i, pixelCount;
       Py_ssize_t dataLen;
       unsigned char *data, *newData, channels;
    ...
    // this is an RGB image, copy the first 3 channels and set the alpha channel
    // to 255
    for(i=0; i < pixelCount; i++)
    {
...
//  {"python_name"  , c_name       , arg_method  , doc_string         },
    ...
    {"string_copy"  , string_copy  , METH_VARARGS, string_copy__doc__   },
    {"swap_channels", swap_channels, METH_VARARGS, swap_channels__doc__},
    {"quick_scale"  , quick_scale  , METH_VARARGS, quick_scale__doc__   },
    {"to_rgb"       , to_rgb       , METH_VARARGS, to_rgb__doc__       },
    {"to_rgba"      , to_rgba      , METH_VARARGS, to_rgba__doc__      },
